package com.jach.labo05.data.session
...
class SessionManager(private val context: Context) {
    ...
    private companion object {
        ...
        val KEY_USER_ID        = stringPreferencesKey("user_id")         // ← nuevo Lab 9
        ...
        val KEY_NOTIFICATIONS_ENABLED = booleanPreferencesKey("notifications_enabled")  // ← nuevo Lab 11
    }
    ...
    val userId: Flow<String?> = context.sessionDataStore.data         // ← nuevo Lab 9
    ...
    val notificationsEnabled: Flow<Boolean> = context.sessionDataStore.data   // ← nuevo Lab 11
    ...
    // Firma actualizada: ahora persiste los tokens junto al username y el user_id (UUID)
    suspend fun login(username: String, access: String, refresh: String, userId: String? = null) {
        context.sessionDataStore.edit { prefs ->
            ...
            if (userId != null) prefs[KEY_USER_ID] = userId   // ← nuevo Lab 9
        }
    }
    ...
    suspend fun setNotificationsEnabled(enabled: Boolean) {   // ← nuevo Lab 11
        context.sessionDataStore.edit { prefs -> prefs[KEY_NOTIFICATIONS_ENABLED] = enabled }
    }
